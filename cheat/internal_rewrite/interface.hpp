...
public:
	...
	c_interface_base< IEffects >		     m_effects;
	...
	struct {
		...
		generic_listener_t item_purchase{ xors( "item_purchase" ), &listeners::item_purchase };
	} listeners;
public:
	...
	__declspec( noinline ) void create( void* iface, const std::string& name ) {
		auto* interface_ = static_cast< c_interface_base< uintptr_t >* >( iface );
