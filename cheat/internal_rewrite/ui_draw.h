...
namespace ui
{
	...
	__forceinline void ui_draw_string( int x, int y, bool center, clr_t color, const char* str, ... ) {
		...
		g_d3d.draw_text( d3d::fonts.f_menu, color, x, y,
			center ? ALIGN_CENTER : ALIGN_LEFT, theme == 0 ? D3DFONTFLAG_DROPSHADOW : 0, buf );
	}
